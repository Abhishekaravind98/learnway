            ...
            <div className='flex'>
                ...
                <div className='basis-auto md:basis-1/2'>
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-3xl font-bold mb-6 md:mb-8 text-center">Study in India</h2>
                        ...
                        <h3 className="text-2xl font-semibold mb-4 text-center">Why Choose India?</h3>
                        <p className="text-lg mb-4 md:mb-6 text-left">
                        ...
                        <h3 className="text-2xl font-semibold mb-4 text-center">Application Process</h3>
                        <p className="text-lg mb-4 md:mb-6 text-left">
